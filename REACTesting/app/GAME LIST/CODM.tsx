...
const CODM = () => {
  const route = useRoute<RouteProp<RootStackParamList, 'CODM'>>();
  ...
  const checkCODMId = async () => {
    ...
    const options = {
      method: 'GET',
      url: `https://id-game-checker.p.rapidapi.com/cod-mobile/${userId}`,
      headers: {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>CODM ID Checker</Text>
      <TextInput
        style={styles.input}
      ...
      />
      <Button title="Check ID" onPress={checkCODMId} />
      {result && (
